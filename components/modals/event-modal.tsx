...
export default function EventModal({ isOpen, storeId, date, onClose, onAdd }: EventModalProps) {
                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
                                ...
                                <div className="pt-6 space-x-2 flex items-center justify-end w-full">
                                    <Button variant="outline" disabled={loading} onClick={exit} className="w-1/4">
                                        Cancel
                                    </Button>
